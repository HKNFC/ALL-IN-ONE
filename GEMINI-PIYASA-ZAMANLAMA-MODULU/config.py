...
RISK_PROFILES = {
    "Korumacı": {
        ...
        "weight_multipliers": {"macro": 1.3, "health": 1.0, "timing": 0.7},
        "allocations": {
    ...
    "Dengeli": {
        ...
        "weight_multipliers": {"macro": 1.0, "health": 1.0, "timing": 1.0},
        "allocations": {
    ...
    "Agresif": {
        ...
        "weight_multipliers": {"macro": 0.7, "health": 1.0, "timing": 1.3},
        "allocations": {
