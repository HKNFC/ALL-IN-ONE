...
BIST_SCORING_WEIGHTS = {
    "financial_strength": 0.30,  # USA: 0.25 → BIST: 0.30
    "growth": 0.25,              # USA: 0.20 → BIST: 0.25
    "margin_quality": 0.15,      # Aynı
    "valuation": 0.15,           # USA: 0.20 → BIST: 0.15
    "momentum": 0.15,            # USA: 0.20 → BIST: 0.15
}
